  ...
  <div class="page">
    ...
    <section id="services" class="band">
      <div class="inner">
        ...
        <p class="services-target">中小企業・小規模事業者向け</p>
        <div class="service-grid">
          ...
          <div class="service-card">
            ...
            <p class="service-body">
              専任のIT担当者がいない企業のために、業務課題をヒアリングして、実際に使いこなせるツールを選びます。導入後も定着するまでサポートします。候補のリストアップまでは無料です。
            </p>
          </div>
        </div>
      </div>
